...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "mhcs" because\n';
 ...
 * "/mhcs.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['mhcs'].superdevmode = true;

  var expectedSuffix = '/mhcs.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + mhcs + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:mhcs';
  var devModeSessionKey = '__gwtDevModeSession:mhcs';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/mhcs/mhcs.nocache.js';
  ...
  $wnd.__gwt_activeModules['mhcs'].canRedirect = true;
  $wnd.__gwt_activeModules['mhcs'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/mhcs?user.agent=' + ua + '&_callback=' + callback;
